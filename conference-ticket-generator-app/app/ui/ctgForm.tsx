    ...
    return (
        <form className="flex flex-col gap-6 max-w-md w-md">
            <div className="flex flex-col gap-2 items-start w-full">
                <label className="text-lg text-[#EAE6FD]">File Upload</label>
                <label className="flex flex-col items-center justify-center w-full border border-dashed border-[#8A84A8] bg-white bg-opacity-10 rounded-xl px-3 py-8 text-center cursor-pointer hover:bg-opacity-20 transition-all">
                    ...
                    <span className="text-[#8A84A8] text-lg">Drag and drop or click to upload</span>
                </label>
                <input
                    id="fileUpload"
                    type="file"
            ...
            <div className="flex flex-col gap-2 items-start">
                <label className=" text-lg text-[#EAE6FD]" htmlFor="fullName" >Full Name</label>
                <input
                    id="fullName"
                    type="text"
            ...
            <div className="flex flex-col gap-2 items-start">
                <label className=" text-lg text-[#EAE6FD]" htmlFor="email" >Email Address</label>
                <input
                    id="email"
                    type="email"
                    className=" text-lg bg-opacity-10 w-full border border-[#8A84A8] bg-white rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
            </div>
            <div className="flex flex-col gap-2 items-start">
                <label className="text-lg text-[#EAE6FD]" htmlFor="githubUsername" >Github Username</label>
                <input
                    id="githubUsername"
                    type="text"
                    className="text-lg bg-opacity-10 w-full border border-[#8A84A8] bg-white rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <button className="font-bold w-full bg-[#F67464] text-[#1B163F] py-3 rounded-xl text-lg">Generate my ticket</button>
        </form>
    )
}